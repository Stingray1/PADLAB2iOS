                                         ...
                                         withFilterContext:(id)filterContext
{
    ...
    {
        NSData *data1 = [@"MavenTwo-2" dataUsingEncoding:NSUTF8StringEncoding];
...
//partea server
    if([msg isEqual:@"GetDataFromNode3"])
    {   [messagequeue removeAllObjects];
        NSData *data1 = [@"Data2" dataUsingEncoding:NSUTF8StringEncoding];
        NSData *data2 = [@"GetDataFromNode2" dataUsingEncoding:NSUTF8StringEncoding];
        [udpSocket sendData:data1 toHost:@"127.0.0.1" port:14333 withTimeout:-1 tag:0];
        [udpSocket sendData:data2 toHost:@"127.0.0.1" port:14111 withTimeout:-1 tag:0];
    }
